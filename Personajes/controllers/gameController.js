...
exports.updateEnergy = (req, res) => {
    ...
    switch (action) {
        case 'feed': // Dar de comer
            character.energyLevel = Math.min(100, character.energyLevel + 1); // Aumentar el nivel de energía
            break;
        case 'play': // Jugar
            character.energyLevel = Math.max(0, character.energyLevel - 1); // Reducir el nivel de energía
            break;
        default:
